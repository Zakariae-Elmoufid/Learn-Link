...
public class ConnectionController {
     ...
     *
     * @param userId the ID of the authenticated user (from header)
     ...
     *
     * @param userId    the ID of the authenticated user (must be the receiver)
     ...
     *
     * @param userId    the ID of the authenticated user (must be the sender)
